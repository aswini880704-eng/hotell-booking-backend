...
useEffect(()=>{
    ...
    return (
        <div className='py-28 md:pb-35 px-4 md:pt-32 md:px-16 lg:px-24 xl:px-32'>

          <Title title='My Bookings' subTitle='Easily manage your past,current and upcoming hotel
          ...
          <div className='max-w-6xl mt-8 w-full text-gray-800'>
            ...
            border-gray-300 font-medium text-base pb-3 '>
...
<div>
    ...
    <div className='flex flex-col items-start justify-center pt-3'>
        <div className='flex item-center gap-2'>
            <div className={`w-3 h-3 rounded-full ${booking.isPaid
    ...
    <p className={`text-sm ${booking.isPaid ? "text-green-500" 
        ...
        {!booking.isPaid && (
            <button className='mt-2 px-4 py-2 bg-blue-600 text-white
            rounded hover:bg-blue-700 transition w-max text-sm'>
                Pay Now
            </button>
        )}
    </div>
