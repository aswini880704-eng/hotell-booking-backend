...
<form  onSubmit={onSubmitHandler}>
  <Title  align='left' font='outfit' title='Add Rooms'
   subTitle='Fill in the details carefully and accurate 
   room details, pricing, and
  ...
  {Object.keys(inputs.amenities).map((amenity,index)=>(
    <div key={index}>
      ...
      checked={inputs.amenities[amenity]} onChange={()=>setInputs
        ({...inputs,amenities: {...inputs.amenities,[amenity]:
...
<button className='px-6 py-2.5 mt-4 rounded text-white bg-blue-500 bg-primary
       hover:bg-primary-dull transition-all cursor-pointer' disabled={loading}>
