...
const Footer = () => {
 ...
 <div className=' bg-[#F6F9FC] text-gray-500/80 pt-8 px-6 md:px-16 
 lg:px-24 xl:px-32'>
            ...
            gap-12 md:gap-6'>
                <div className='max-w-80'>
                    ...
                    <p className='text-sm'>
                        Discover the worl's most extrordinary places to 
                ...
                <div className='max-w-80'>
                    ...
                    <div className='flex items-center mt-4'>
                        ...
                        justify-center bg-black h-9 w-9 
                        aspect-square rounded-r'>
